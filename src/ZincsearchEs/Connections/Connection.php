...
use ZincsearchEs\Client;
use ZincsearchEs\Common\Exceptions\AlreadyExpiredException;
use ZincsearchEs\Common\Exceptions\BadRequest400Exception;
use ZincsearchEs\Common\Exceptions\Conflict409Exception;
use ZincsearchEs\Common\Exceptions\Curl\CouldNotConnectToHost;
use ZincsearchEs\Common\Exceptions\Curl\CouldNotResolveHostException;
use ZincsearchEs\Common\Exceptions\Curl\OperationTimeoutException;
use ZincsearchEs\Common\Exceptions\Forbidden403Exception;
use ZincsearchEs\Common\Exceptions\MaxRetriesException;
use ZincsearchEs\Common\Exceptions\Missing404Exception;
use ZincsearchEs\Common\Exceptions\NoDocumentsToGetException;
use ZincsearchEs\Common\Exceptions\NoShardAvailableException;
use ZincsearchEs\Common\Exceptions\RequestTimeout408Exception;
use ZincsearchEs\Common\Exceptions\RoutingMissingException;
use ZincsearchEs\Common\Exceptions\ScriptLangNotSupportedException;
use ZincsearchEs\Common\Exceptions\ServerErrorResponseException;
...
class Connection implements ConnectionInterface
{
     ...
     * @return \ZincsearchEs\Common\Exceptions\Curl\CouldNotConnectToHost|\ZincsearchEs\Common\Exceptions\Curl\CouldNotResolveHostException|\ZincsearchEs\Common\Exceptions\Curl\OperationTimeoutException|\ZincsearchEs\Common\Exceptions\MaxRetriesException
     */
     ...
     * @param array $response
     * @param array $ignore
     * @throws \ZincsearchEs\Common\Exceptions\AlreadyExpiredException|\ZincsearchEs\Common\Exceptions\BadRequest400Exception|\ZincsearchEs\Common\Exceptions\Conflict409Exception|\ZincsearchEs\Common\Exceptions\Forbidden403Exception|\ZincsearchEs\Common\Exceptions\Missing404Exception|\ZincsearchEs\Common\Exceptions\ScriptLangNotSupportedException
     */
     ...
     * @param array $response
     * @param array $ignore
     * @throws \ZincsearchEs\Common\Exceptions\NoDocumentsToGetException|\ZincsearchEs\Common\Exceptions\NoShardAvailableException|\ZincsearchEs\Common\Exceptions\RoutingMissingException|\ZincsearchEs\Common\Exceptions\ServerErrorResponseException
     */
    ...
    {
        return $this->tryDeserializeError($response, 'ZincsearchEs\Common\Exceptions\BadRequest400Exception');
    }

    private function tryDeserialize500Error($response)
    {
        return $this->tryDeserializeError($response, 'ZincsearchEs\Common\Exceptions\ServerErrorResponseException');
    }
